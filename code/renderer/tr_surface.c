...
void RB_Line(const vec3_t start, const vec3_t end, const vec3_t linedirection, const vec3_t left,
	     vec3_t *corners, float starttex, float endtex, const refEntity_t *e)
{
	...
	vertcols[ndx].rgba[0] = vertcols[ndx+1].rgba[0] = vertcols[ndx+2].rgba[0] = vertcols[ndx+3].rgba[0] = e->shader.rgba[0];
	vertcols[ndx].rgba[1] = vertcols[ndx+1].rgba[1] = vertcols[ndx+2].rgba[1] = vertcols[ndx+3].rgba[1] = e->shader.rgba[1];
	vertcols[ndx].rgba[2] = vertcols[ndx+1].rgba[2] = vertcols[ndx+2].rgba[2] = vertcols[ndx+3].rgba[2] = e->shader.rgba[2];
	vertcols[ndx].rgba[3] = vertcols[ndx+1].rgba[3] = vertcols[ndx+2].rgba[3] = vertcols[ndx+3].rgba[3] = e->shader.rgba[3];
...
void RB_SurfaceLine2( void )
{
	...
	vertcols[ndx].rgba[0] = vertcols[ndx+1].rgba[0] = vertcols[ndx+2].rgba[0] =
		vertcols[ndx+3].rgba[0] = vertcols[ndx+4].rgba[0] = vertcols[ndx+5].rgba[0] = e->shader.rgba[0];
	vertcols[ndx].rgba[1] = vertcols[ndx+1].rgba[1] = vertcols[ndx+2].rgba[1] =
		vertcols[ndx+3].rgba[1] = vertcols[ndx+4].rgba[1] = vertcols[ndx+5].rgba[1] = e->shader.rgba[1];
	vertcols[ndx].rgba[2] = vertcols[ndx+1].rgba[2] = vertcols[ndx+2].rgba[2] =
		vertcols[ndx+3].rgba[2] = vertcols[ndx+4].rgba[2] = vertcols[ndx+5].rgba[2] = e->shader.rgba[2];
	vertcols[ndx].rgba[3] = vertcols[ndx+1].rgba[3] = vertcols[ndx+2].rgba[3] =
		vertcols[ndx+3].rgba[3] = vertcols[ndx+4].rgba[3] = vertcols[ndx+5].rgba[3] = e->shader.rgba[3];
...
void RB_SurfaceCylinder(void)
{
	...
	while(index < planes)
	{
		...
		vertcols[ndx].rgba[1] = vertcols[ndx+1].rgba[1] = vertcols[ndx+2].rgba[1] = vertcols[ndx+3].rgba[1] = e->shader.rgba[1];
		vertcols[ndx].rgba[2] = vertcols[ndx+1].rgba[2] = vertcols[ndx+2].rgba[2] = vertcols[ndx+3].rgba[2] = e->shader.rgba[2];
		vertcols[ndx].rgba[3] = vertcols[ndx+1].rgba[3] = vertcols[ndx+2].rgba[3] = vertcols[ndx+3].rgba[3] = 0xff;
